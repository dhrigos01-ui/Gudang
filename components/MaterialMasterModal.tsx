...
interface MaterialMasterModalProps {
  // FIX: Update prop types to use LeatherMaster and LeatherInventoryItem.
...
export const MaterialMasterModal: React.FC<MaterialMasterModalProps> = ({ leatherMasters, leatherInventory, onClose, onDataChanged }) => {
  ...
  return (
    <Modal title="Manajemen Master Data Kulit" onClose={onClose}>
