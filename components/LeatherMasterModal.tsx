...
interface LeatherMasterModalProps {
...
export const LeatherMasterModal: React.FC<LeatherMasterModalProps> = ({ leatherMasters, leatherInventory, onClose, onDataChanged }) => {
